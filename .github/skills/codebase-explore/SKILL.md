...
description: Explores the codebase to understand an unfamiliar area, maps key files and their responsibilities, traces data flow, and identifies dependencies. Use when the user asks to explore, investigate, or understand how a part of the codebase works.
---
